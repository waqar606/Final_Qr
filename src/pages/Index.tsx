...
const Index = () => {
  ...
  const qrData = selectedType
    ? encodeQRData(selectedType, content, tempId)
    : "";

  const handleNext = () => {
    if (step === 1 && !selectedType) {
      toast.error("Please select a QR type");
      return;
    }
          ...
          <PhoneMockup>
            {step >= 2 && qrData ? (
              ...
              <div className="text-center p-6">
                <div className="w-50 h-50 mx-auto mb-4 border-2 border-dashed border-border rounded-xl flex items-center justify-center">
